...
# ${IREE_BUILD_DIR}/tools/iree-opt matmul_peeled_2x2_small.mlir --mlir-print-ir-before-all --debug-only=iree-amdaie-distribute-cores-and-objectfifos --pass-pipeline="builtin.module(fold-memref-alias-ops,iree-amdaie-pack-to-dma,air-copy-to-dma,iree-amdaie-air-dma-to-amdaie-dma,iree-amdaie-insert-cores,iree-amdaie-localize-logicalobjectfifo,cse,iree-amdaie-distribute-cores-and-objectfifos,cse,iree-amdaie-dma-to-circular-dma,func.func(iree-amdaie-create-aie-workgroup),canonicalize,cse,iree-amdaie-canonicalize-doubly-strided-op,iree-amdaie-consume-produce-to-acquire-release,cse,canonicalize,iree-amdaie-controlcode-loop-unroll,cse,canonicalize,iree-amdaie-lower-to-aie,canonicalize,convert-linalg-to-loops)"
# ${IREE_BUILD_DIR}/tools/iree-opt matmul_peeled_2x2.mlir --mlir-print-ir-before-all --debug-only=iree-amdaie-distribute-cores-and-objectfifos --pass-pipeline="builtin.module(fold-memref-alias-ops,iree-amdaie-pack-to-dma,air-copy-to-dma,iree-amdaie-air-dma-to-amdaie-dma,iree-amdaie-insert-cores,iree-amdaie-localize-logicalobjectfifo,cse,iree-amdaie-distribute-cores-and-objectfifos,cse,iree-amdaie-dma-to-circular-dma,func.func(iree-amdaie-create-aie-workgroup),canonicalize,cse,iree-amdaie-canonicalize-doubly-strided-op,iree-amdaie-consume-produce-to-acquire-release,cse,canonicalize,iree-amdaie-dma-loop-subsumption)"
...
#     --mlir-print-ir-before-all \
#     --mlir-disable-threading &> debug.log
